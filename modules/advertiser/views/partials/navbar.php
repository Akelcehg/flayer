    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand navbar-brand-image" href="./index.html">
                <img src="./img/advertiser/logo.png" alt="Site Logo">
            </a>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu noticebar-menu" role="menu">
                        ...
                        <li>
                            <a href="./page-notifications.html" class="noticebar-item">
                <span class="noticebar-item-image">
                  <img src="./img/advertiser/avatars/avatar-1-md.jpg" style="width: 50px" alt="">
                </span>
                  ...
                  <span class="noticebar-item-time"><i class="fa fa-clock-o"></i> 20 minutes ago</span>
                        ...
                        <li>
                            <a href="./page-notifications.html" class="noticebar-item">
                <span class="noticebar-item-image">
                  <img src="./img/advertiser/avatars/avatar-2-md.jpg" style="width: 50px" alt="">
                </span>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown navbar-profile">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:;">
                        <img src="./img/advertiser/avatars/avatar-1-xs.jpg" class="navbar-profile-avatar" alt="">
